...
public class RuntimeDataPollingServiceTest {
    ...
    void setup() {
        ...
        pollingService = new RuntimeDataPollingService(pollingApiService, lastPolledService, eventSendService, applicationProperties);
    }
    ...
    void pollFinishedProcessInstances(PointOfTime processStart, PointOfTime processEnd, boolean shouldBePolled) {
        ...
        final ProcessInstance processInstance = processEngine
                .getRuntimeService()
        ...
        final List<String> polledProcessIds = processInstanceEventCaptor
                .getAllValues()
                .stream()
    ...
    void pollFinishedActivitiesOfUnfinishedProcess(PointOfTime processStart, PointOfTime activityStart, PointOfTime activityEnd, boolean shouldBePolled) {
        ...
        // send pause1 message on activityStart to resume and start pause2 activity on given time
        ...
        // send pause2 message on activityEnd to resume and end pause2 activity on given time
        ...
        assertEquals(shouldBePolled ? 1 : 0, historyEventCaptor
                .getAllValues()
                .stream()
    ...
    void pollUnfinishedActivitiesOfUnfinishedProcess(PointOfTime processStart, PointOfTime activityStart, boolean shouldBePolled) {
