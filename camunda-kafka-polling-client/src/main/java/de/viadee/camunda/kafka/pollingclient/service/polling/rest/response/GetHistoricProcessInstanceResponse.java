...
public class GetHistoricProcessInstanceResponse {
    ...
    public java.lang.String toString() {
        return "GetHistoricProcessInstanceResponse(id=" + this.getId() + ", superProcessInstanceId=" + this.getSuperProcessInstanceId() + ", superCaseInstanceId=" + this.getSuperCaseInstanceId() + ", caseInstanceId=" + this.getCaseInstanceId() + ", processDefinitionName=" + this.getProcessDefinitionName() + ", processDefinitionKey=" + this.getProcessDefinitionKey() + ", processDefinitionVersion=" + this.getProcessDefinitionVersion() + ", processDefinitionId=" + this.getProcessDefinitionId() + ", businessKey=" + this.getBusinessKey() + ", startTime=" + this.getStartTime() + ", endTime=" + this.getEndTime() + ", durationInMillis=" + this.getDurationInMillis() + ", startUserId=" + this.getStartUserId() + ", startActivityId=" + this.getStartActivityId() + ", deleteReason=" + this.getDeleteReason() + ", tenantId=" + this.getTenantId() + ", state=" + this.getState() + ")";
    }
}
