...
public class GetHistoricVariableInstancesResponse {
    ...
    public java.lang.String toString() {
        return "GetHistoricVariableInstancesResponse(id=" + this.getId() + ", name=" + this.getName() + ", type="
                + this.getType() + ", value=" + this.getValue() + ", valueInfo=" + this.getValueInfo()
                + ", processDefinitionKey=" + this.getProcessDefinitionKey() + ", processDefinitionId="
                + this.getProcessDefinitionId() + ", processInstanceId=" + this.getProcessInstanceId()
                + ", executionId=" + this.getExecutionId() + ", activityInstanceId=" + this.getActivityInstanceId()
                + ", caseDefinitionKey=" + this.getCaseDefinitionKey() + ", caseDefinitionId="
                ...
                + ", errorMessage=" + this.getErrorMessage() + ", state=" + this.getState() + ")";
    }
}
