...
public class GetHistoricActivityInstanceRespone {
    ...
    public java.lang.String toString() {
        return "GetHistoricActivityInstanceRespone(id=" + this.getId() + ", parentActivityInstanceId=" + this.getParentActivityInstanceId() + ", activityId=" + this.getActivityId() + ", activityName=" + this.getActivityName() + ", activityType=" + this.getActivityType() + ", processDefinitionKey=" + this.getProcessDefinitionKey() + ", processDefinitionId=" + this.getProcessDefinitionId() + ", processInstanceId=" + this.getProcessInstanceId() + ", executionId=" + this.getExecutionId() + ", taskId=" + this.getTaskId() + ", assignee=" + this.getAssignee() + ", calledProcessInstanceId=" + this.getCalledProcessInstanceId() + ", calledCaseInstanceId=" + this.getCalledCaseInstanceId() + ", startTime=" + this.getStartTime() + ", endTime=" + this.getEndTime() + ", durationInMillis=" + this.getDurationInMillis() + ", canceled=" + this.getCanceled() + ", completeScope=" + this.getCompleteScope() + ", tenantId=" + this.getTenantId() + ")";
    }
}
